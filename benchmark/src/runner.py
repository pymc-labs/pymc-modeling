...
SKILL_PATH = BENCHMARK_DIR.parent / "skills" / "pymc-modeling" / "SKILL.md"
...
def run_single(
    ...
    # No timeout — let runs take as long as they need
    logger.info(f"Running: {task_id} {condition} rep{rep} (no timeout)")
    start = time.time()
    raw = ""
    error = ""
